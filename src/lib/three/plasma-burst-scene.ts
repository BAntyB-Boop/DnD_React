...
// "The Veiled Codex" theme (ADR-0021): retinted from the original blue/violet
// energy burst to a gold/amber arcane-fire palette. Same structure/positions in
// PlasmaConfig — only the hex values changed.
...
const colPink = "#fff4e6"; // warm-white, not the original cool lavender-white
